            ...
            <div>
              <div class="float-left">
                <div class="trc">
                  ...
                  <a class="close" onclick="return delete_dialog('<?php echo $country['pk_c_code']; ?>', 'delete_country');" href="<?php echo osc_admin_base_url(true); ?>?page=locations&action=delete_country&id[]=<?php echo $country['pk_c_code']; ?>">
