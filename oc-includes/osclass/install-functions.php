...
function display_finish($password) {
  ...
  <div class="row cron-setup"><?php echo sprintf(__("Don't forget to setup %s and %s after installation."), '<a target="_blank" href="https://docs.osclass-classifieds.com/cron-setup-i82">CRON</a>', '<a target="_blank" href="https://docs.osclass-classifieds.com/setting-up-a-mail-server">' . __('Mail server') . '</a>'); ?></div>
